...
const Jss3 = () => {
    ...
    const { showSideBar, hideSideBar, showBack, setShowBack, setAddSetModal, setClassType, getSchoolDetails, setJss3, jss3Set, jss3Set2, viewStudents, deleteSet, deleteSetModal,
