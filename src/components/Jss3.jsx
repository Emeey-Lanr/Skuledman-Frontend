...
const Jss3 = () => {
    ...
    const { showSideBar, hideSideBar, showBack, setShowBack, setAddSetModal, setClassType, getSchoolDetails, jss3Set, viewStudents, setDetails, setLastRoute } = useContext(appContext)
    useLayoutEffect(() => {
        getSchoolDetails()
    }, [])
